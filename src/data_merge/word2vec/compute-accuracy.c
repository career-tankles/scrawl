...
int main(int argc, char **argv)
{
  ...
  while (1) {
    ...
    scanf("%s", st1);
    for (a = 0; a < (int)strlen(st1); a++) st1[a] = toupper(st1[a]);
    ...
    scanf("%s", st2);
    for (a = 0; a < (int)strlen(st2); a++) st2[a] = toupper(st2[a]);
    scanf("%s", st3);
    for (a = 0; a<(int)strlen(st3); a++) st3[a] = toupper(st3[a]);
    scanf("%s", st4);
    for (a = 0; a < (int)strlen(st4); a++) st4[a] = toupper(st4[a]);
