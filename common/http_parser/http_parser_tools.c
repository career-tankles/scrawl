...
count_body_cb (http_parser *p, const char *buf, size_t len)
{
  ...
  check_body_is_final(p);
    //fprintf(stderr, "body-szie:%d \n%s\n", messages[num_messages].body_size, buf);
    fprintf(stderr, "body-szie:%d %c %c\n", messages[num_messages].body_size, *buf, *(buf+1));
  return 0;
}
...
headers_complete_cb (http_parser *p)
{
  ...
  fprintf(stderr, "headers_complete_cb: %s %d\n", messages[num_messages].method, messages[num_messages].status_code);
...
//    int l = sscanf(data, "%[a-zA-Z0-9]: %[^\r\n]", key, value);
//    fprintf(stderr, "%s: %s\n", key, value);
//    l = sscanf(data+l, "%[a-zA-Z0-9]: %[^\r\n]", key, value);
//    fprintf(stderr, "%s: %s\n", key, value);
//    return 0;
