#ifndef __febird_automata_suffix_dfa_hpp__
#define __febird_automata_suffix_dfa_hpp__
...
//			children.erase_all();
			A.for_each_move(p0,[&](state_id_t p,const trans_t& t,auchar_t c){
				state_id_t q = t;
...
#endif // __febird_automata_suffix_dfa_hpp__
