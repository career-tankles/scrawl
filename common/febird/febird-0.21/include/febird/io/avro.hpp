/* vim: set tabstop=4 : */
#ifndef __febird_io_avro_h__
#define __febird_io_avro_h__
...
class AvroDataInput : public
	DATA_IO_BASE_IO(AvroDataInput, LittleEndian, VarIntVar, Input, StreamT)
{
public:
	using
	DATA_IO_BASE_IO(AvroDataInput, LittleEndian, VarIntVar, Input, StreamT)
...
template<class StreamT>
class AvroDataOutput : public
	DATA_IO_BASE_IO(AvroDataOutput, LittleEndian, VarIntVar, Output, StreamT)
{
public:
	using
	DATA_IO_BASE_IO(AvroDataOutput, LittleEndian, VarIntVar, Output, StreamT)
...
} // namespace febird::avro

#endif // __febird_io_avro_h__
