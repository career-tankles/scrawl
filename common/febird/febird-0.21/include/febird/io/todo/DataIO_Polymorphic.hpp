/* vim: set tabstop=4 : */
#ifndef __febird_io_DataIO_Polymorphic_h__
#define __febird_io_DataIO_Polymorphic_h__
...
#define DATA_IO_POLYM_LOAD_EX(Input,Class)	\
	febird::serialization::polymorphic::InputImplement<Input, Class> \
...
#endif // __febird_io_DataIO_Polymorphic_h__
