#ifndef __febird_bdb_util_utility_h__
#define __febird_bdb_util_utility_h__

/**
 @file 几个便于使用的 BDB 实用类
  
  db_cxx.h 中的 Dbc, DbTxn 类不是使用析构函数来释放资源和提交更改
  如果需要这些功能，请使用 febird::DbCursor, febird::DbTxnGuard
...
#endif // __febird_bdb_util_utility_h__
