#ifndef __febird_num_to_str_hpp__
#define __febird_num_to_str_hpp__

#include <string>
#include <string.h> // for strlen

int num_to_str(char* buf, bool x);
int num_to_str(char* buf, short x);
int num_to_str(char* buf, int x);
int num_to_str(char* buf, long x);
int num_to_str(char* buf, long long x);
int num_to_str(char* buf, unsigned short x);
int num_to_str(char* buf, unsigned int x);
int num_to_str(char* buf, unsigned long x);
int num_to_str(char* buf, unsigned long long x);
...
#endif // __febird_num_to_str_hpp__
