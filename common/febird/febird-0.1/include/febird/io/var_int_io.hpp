...
{
	if (febird_likely(this->buf_remain_bytes() >= 5))
	{
...
{
	if (febird_likely(this->buf_remain_bytes() >= 10))
	{
...
{
	if (febird_likely(this->buf_remain_bytes() >= 4))
	{
...
{
	if (febird_likely(this->buf_remain_bytes() >= 8))
	{
