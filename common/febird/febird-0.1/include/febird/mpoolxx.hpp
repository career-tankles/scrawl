/* vim: set tabstop=4 : */
#ifndef __febird_mpool_cxx_h__
#define __febird_mpool_cxx_h__
...
//		static struct mpool* s_globalpool;
	public:
		...
		{	// allocate array of _Count elements
			if (febird_unlikely(_Count <= 0))
				_Count = 0;
			else if (febird_unlikely(((size_t)(-1) / _Count) < sizeof (T)))
				throw std::bad_alloc();
