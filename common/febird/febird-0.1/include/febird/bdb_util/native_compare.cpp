...
#include "../../obsoleted/wordseg/compare.hpp"
...
{
	return bdb_locale_mash_strcmp_impl(db, dbt1, dbt2, &febird::wordseg::strncasecoll);
}
...
{
	return bdb_locale_mash_strcmp_impl(db, dbt1, dbt2, &febird::wordseg::strncoll);
}
...
{
	return bdb_locale_strcmp_impl(db, dbt1, dbt2, &febird::wordseg::strncasecoll);
}
...
{
	return bdb_locale_strcmp_impl(db, dbt1, dbt2, &febird::wordseg::strncoll);
}
